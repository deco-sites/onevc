...
const variants = {
  primary:
    "p-[12px] md:(py-[14px] px-[23px]) bg-white font-button text-button text-black border-black border-1 hover:bg-black text-white disabled:border-default disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none ",
  secondary:
  ...
  tertiary:
    "h-[36px] px-3 bg-interactive-inverse font-button text-button border-transparent hover:bg-hover active:border-interactive disabled:border-transparent disabled:text-subdued focus:outline-none",
  icon:
    "h-[36px] px-2-full bg-transparent text-default border-transparent disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
